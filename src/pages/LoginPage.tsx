    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    background: `radial-gradient(1000px circle at ${mousePosition.x}px ${mousePosition.y}px, rgba(168, 85, 247, 0.1), transparent 40%)`
                }}
            />
            ...
            <div className="hidden lg:flex w-1/2 relative flex-col justify-between p-12 overflow-hidden bg-black/20 border-r border-white/5 z-10">
                ...
                <div className="relative z-10 max-w-lg">
                    ...
                    <p className="text-gray-400 text-lg leading-relaxed">
                        Sign in to access your dashboard, manage your event registrations, and connect with the BECon community.
                    </p>
                </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative">
                ...
                <div className="absolute top-0 right-0 w-full h-full lg:hidden overflow-hidden pointer-events-none">
                    <div className="absolute -top-32 -right-32 w-80 h-80 bg-purple-600/20 rounded-full blur-[100px]" />
                </div>
                ...
                <div className="w-full max-w-md space-y-8 relative z-10">
                    ...
                    <div className="hidden lg:block">
                        ...
                        <p className="text-gray-400 mt-2">Enter your details to proceed</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full py-3.5 rounded-xl bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white font-medium shadow-lg shadow-purple-900/20 hover:shadow-purple-900/40 transition-all flex items-center justify-center gap-2 group disabled:opacity-70 disabled:cursor-not-allowed"
                        >
                            {isLoading ? (
