...
const regionalEventsData: EventCard[] = [
    ...
    },
    {
        ...
        description: 'Pitch to leading investors and unlock powerful funding opportunities. Moonshot is a national pitching platform where promising startups from Seed to Pre-Series A present their ideas to leading venture capitalists and investors. Top startups from cities like Bengaluru, Mumbai, Hyderabad, Guwahati, Chennai, and Jaipur get the chance to pitch on a powerful stage in front of decision-makers.',
        date: 'Jan 2026',
        location: 'Multiple Cities',
        category: 'competition',
        featured: true,
