                ...
                <div className="space-y-16">
                    {scheduleData.length > 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-20 text-center">
                            <h3 className="text-4xl md:text-6xl font-bold text-white/20 mb-4 uppercase tracking-widest">Coming Soon</h3>
                            <p className="text-gray-500 text-xl font-light">The full schedule for BECon 2026 will be announced shortly.</p>
                        </div>
                    )}
                </div>
            </div>
